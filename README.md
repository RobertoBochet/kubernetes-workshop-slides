...
The slides are available [here](https://robertobochet.github.io/kubernetes-workshop-slides/).
...
These slides are built with [Slidev](https://sli.dev/). You can run them locally using `bun dev`.

These slides are licensed under [CC-BY-SA-4.0](https://creativecommons.org/licenses/by-sa/4.0/).
